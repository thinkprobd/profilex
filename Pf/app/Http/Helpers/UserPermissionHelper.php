...
class UserPermissionHelper
{
    ...
    public static function userFeaturesCount($userId)
    {
        ...
        $userFeaturesCount = [];
        $userFeaturesCount['blogs'] = $user->blogs()->count();
        $userFeaturesCount['blogCategories'] = $user->blog_categories()->count();
        $userFeaturesCount['services'] =  $user->services()->count();
        $userFeaturesCount['skills'] =  $user->skills()->count();
        $userFeaturesCount['portfolios'] = $user->portfolios()->count();
        $userFeaturesCount['portfolioCategories'] = $user->portfolioCategories()->count();
        $userFeaturesCount['jobExpriences'] = $user->job_experiences()->count();
        $userFeaturesCount['educations'] = $user->educations()->count();
        $userFeaturesCount['languages'] = $user->languages()->where('type', 'user')->count();
        $userFeaturesCount['vcards'] = $user->vcards()->count();
